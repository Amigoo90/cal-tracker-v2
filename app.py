    ...
    if st.button("تحليل الوجبة الآن"):
        with st.spinner('يتم الآن فحص الصورة واستخراج البيانات...'):
            try:
                ...
                3. أعط نصيحة محددة لزيادة الوزن وبناء العضلات بناءً على هذه الوجبة.
                """
                ...
                st.info("نصيحة: تأكد من أن مفتاح API في Secrets فعال ولم يتجاوز حد الاستخدام اليومي.")
